# RC-HPM — Risk-Controlled Hard-Pair Mining for Contrastive Learning and EqM

Research codebase. Builds on Equilibrium Matching (EqM). Adds **risk-controlled hard-pair mining**:
adaptive selection of hard positive/negative pairs with a calibrated risk bound, applied to both
contrastive learning and EqM regression targets.

Upstream EqM: [Paper](https://arxiv.org/abs/2510.02300) | [Project Page](https://raywang4.github.io/equilibrium_matching/)

<img src="eqm.png" width="700" height="700">
This repo is forked from the official PyTorch implementation of Equilibrium Matching (below).
