...
| 5 | Online equal-NFE adaptive sampler beats random | **LOGIC-VALIDATED (mock)** | mock: probe 0.212 vs random 0.385 at identical NFE; early-signal AUROC 0.814@k100 | EqM-scale `online_adaptive.sbatch`: probe-restart < random-restart at equal NFE |
