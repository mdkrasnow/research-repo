...
if __name__=='__main__':
 p=argparse.ArgumentParser();p.add_argument('--direct',required=True);p.add_argument('--dot',required=True);p.add_argument('--real',required=True);p.add_argument('--output',required=True);p.add_argument('--samples',type=int,default=32);p.add_argument('--steps',type=int,default=10);p.add_argument('--step',type=float,default=.003);p.add_argument('--batch',type=int,default=4);p.add_argument('--fid-batch',type=int,default=16);p.add_argument('--seed',type=int,default=20260729);main(p.parse_args())
