...
if __name__=="__main__":
 p=argparse.ArgumentParser();p.add_argument("--ckpt",required=True);p.add_argument("--output",required=True);p.add_argument("--ebm",choices=["none","dot","direct","forward-backwards-direct"],required=True);p.add_argument("--model",default="EqM-S/2",choices=list(EqM_models.keys()));p.add_argument("--image-size",type=int,default=256);p.add_argument("--num-classes",type=int,default=1000);p.add_argument("--vae",default="ema");p.add_argument("--weights",choices=["model","ema"],default="model");p.add_argument("--num-samples",type=int,default=16);p.add_argument("--steps",type=int,default=50);p.add_argument("--stepsize",type=float,default=.003);p.add_argument("--seed",type=int,default=123);main(p.parse_args())
