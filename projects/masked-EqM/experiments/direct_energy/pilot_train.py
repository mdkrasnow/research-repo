...
if __name__=="__main__":
 p=argparse.ArgumentParser(); p.add_argument("--data-path",required=True);p.add_argument("--output",required=True);p.add_argument("--ebm",choices=["none","dot","direct","forward-backwards-direct"],required=True);p.add_argument("--model",default="EqM-S/2",choices=list(EqM_models.keys()));p.add_argument("--image-size",type=int,default=256);p.add_argument("--num-classes",type=int,default=1000);p.add_argument("--vae",default="ema");p.add_argument("--batch-size",type=int,default=8);p.add_argument("--latent-pool-size",type=int,default=256);p.add_argument("--vae-batch-size",type=int,default=16);p.add_argument("--num-workers",type=int,default=4);p.add_argument("--steps",type=int,default=1000);p.add_argument("--lr",type=float,default=1e-4);p.add_argument("--ema-decay",type=float,default=.9999);p.add_argument("--seed",type=int,default=0);main(p.parse_args())
